...
export class DevnetTestHarness {
    ...
    static async create(opts) {
        ...
        if (typeof process !== 'undefined' && process.versions?.node) {
            ...
            const wasmJsUrl = new URL('./wasm/qubitcoin_web_sys_bg.wasm', "file://" + __dirname + "/devnet-server.js");
            let wasmPath;
            try {
                ...
                const thisDir = dirname(fileURLToPath("file://" + __dirname + "/devnet-server.js"));
