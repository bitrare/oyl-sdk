 ...
 * @returns {string}
 */
function analyze_psbt(psbt_base64, network_str) {
    let deferred4_0;
    let deferred4_1;
    try {
...
exports.analyze_psbt = analyze_psbt;
 ...
 * @returns {string}
 */
function analyze_runestone(tx_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(tx_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.analyze_runestone = analyze_runestone;
 ...
 * @returns {Promise<any>}
 */
function brc20_prog_deploy_contract(network, foundry_json, params_json) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.brc20_prog_deploy_contract = brc20_prog_deploy_contract;
 ...
 * @returns {Promise<any>}
 */
function brc20_prog_transact(network, contract_address, function_signature, calldata, params_json) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.brc20_prog_transact = brc20_prog_transact;
 ...
 * @returns {Promise<any>}
 */
function brc20_prog_wrap_btc(network, amount, target_contract, function_signature, calldata, params_json) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.brc20_prog_wrap_btc = brc20_prog_wrap_btc;
 ...
 * @returns {string}
 */
function decode_psbt(psbt_base64) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(psbt_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.decode_psbt = decode_psbt;
 ...
 * @returns {Promise<any>}
 */
function frbtc_get_signer_address(network) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.frbtc_get_signer_address(ptr0, len0);
    return ret;
}
exports.frbtc_get_signer_address = frbtc_get_signer_address;
 ...
 * @returns {Promise<any>}
 */
function frbtc_unwrap(network, amount, vout, recipient_address, params_json) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.frbtc_unwrap = frbtc_unwrap;
 ...
 * @returns {Promise<any>}
 */
function frbtc_wrap(network, amount, params_json) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Promise<any>}
 */
function frbtc_wrap_and_execute(network, amount, script_bytecode, params_json) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.frbtc_wrap_and_execute = frbtc_wrap_and_execute;
 ...
 * @returns {Promise<any>}
 */
function frbtc_wrap_and_execute2(network, amount, target_address, function_signature, calldata_args, params_json) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.frbtc_wrap_and_execute2 = frbtc_wrap_and_execute2;
 ...
 * @returns {Promise<any>}
 */
function get_alkane_bytecode(network, block, tx, block_tag) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.get_alkane_bytecode = get_alkane_bytecode;
 ...
 * @returns {Promise<any>}
 */
function get_alkane_meta(network, block, tx, block_tag) {
    const ptr0 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(block_tag, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.get_alkane_meta = get_alkane_meta;
 ...
 * @returns {Promise<any>}
 */
function simulate_alkane_call(alkane_id_str, wasm_hex, cellpack_hex) {
...
exports.simulate_alkane_call = simulate_alkane_call;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_clearTimeout_5db739eb9091b37c: function(arg0) {
            const ret = clearTimeout(arg0);
            return ret;
        },
        __wbg_connect_7e0e52a995d66bc1: function(arg0) {
        ...
        __wbg_decrypt_1b72b2941d2dfb44: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
            const ret = arg0.decrypt(arg1, arg2, getArrayU8FromWasm0(arg3, arg4));
            return ret;
        }, arguments); },
        __wbg_deriveBits_5738cc9a13a38aec: function() { return handleError(function (arg0, arg1, arg2, arg3) {
            const ret = arg0.deriveBits(arg1, arg2, arg3 >>> 0);
            return ret;
        }, arguments); },
        __wbg_disconnect_28d5361403e91b2e: function(arg0) {
        ...
        __wbg_encrypt_f249dadef2c0f0ba: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
        ...
        __wbg_fetch_3d08fa8b3caa5cf7: function(arg0) {
        ...
        __wbg_getAccounts_ae121c0a1e74deef: function(arg0) {
            const ret = arg0.getAccounts();
            return ret;
        },
        __wbg_getBalance_d750c654508b9e26: function(arg0) {
            const ret = arg0.getBalance();
            return ret;
        },
        __wbg_getInfo_2f5f96913db24745: function(arg0) {
            const ret = arg0.getInfo();
            return ret;
        },
        __wbg_getInscriptions_33763691ba0be59e: function(arg0, arg1, arg2) {
        ...
        __wbg_getNetwork_90fad8bc0d0c14c2: function(arg0) {
            const ret = arg0.getNetwork();
            return ret;
        },
        __wbg_getPublicKey_1db490c01333436a: function(arg0) {
        ...
        __wbg_pushPsbt_57e9bb97befe68ba: function(arg0, arg1, arg2) {
            const ret = arg0.pushPsbt(getStringFromWasm0(arg1, arg2));
            return ret;
        },
        __wbg_pushTx_16e80c6176095f04: function(arg0, arg1, arg2) {
        ...
        __wbg_setTimeout_f863349add4de61f: function(arg0, arg1) {
            const ret = setTimeout(arg0, arg1);
            return ret;
        },
        ...
        __wbg_signMessage_c82d87f3c9b483fc: function(arg0, arg1, arg2, arg3, arg4) {
            const ret = arg0.signMessage(getStringFromWasm0(arg1, arg2), getStringFromWasm0(arg3, arg4));
            return ret;
        },
        __wbg_signPsbt_f6807c996d7476d6: function(arg0, arg1, arg2, arg3) {
            const ret = arg0.signPsbt(getStringFromWasm0(arg1, arg2), arg3);
            return ret;
        },
        __wbg_signPsbts_43afe2e25d24a995: function(arg0, arg1, arg2) {
        ...
        __wbg_switchNetwork_06dfbb04ab0de615: function(arg0, arg1, arg2) {
        ...
        __wbg_wasmbrowserwalletprovider_new: function(arg0) {
            const ret = WasmBrowserWalletProvider.__wrap(arg0);
            return ret;
        },
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 3204, function: Function { arguments: [], shim_idx: 3205, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        ...
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 4631, function: Function { arguments: [Externref], shim_idx: 4632, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
